...
def main4():
    ...
    def getguess():
        ...
        if guess.isalpha():
            ...
            if guessnum <= chances:
                ...
                if len(guess) == 5:
                    if wd == guess:
                        messagebox.showinfo("You Won!!", f"The Word Was {wd.title()} ... You Won!!")
    ...
    print("\n-----------------------------------------------------------------")
    print("            Wordle 5.0 (The Word Guessing Game)           ")
    print("-------------------------------------------------------------------")
    print(f"Enjoy The Game!! Hope You Win!!")
    while True:
